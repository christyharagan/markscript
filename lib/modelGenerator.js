                        ...
                        onClassConstructorDecorator: function (decorator) {
                            switch (decorator.decoratorType.name) {
                                case 'mlExtension':
                                    ...
                                    var extensionModuleName = '_extensions-' + s.classConstructorToString(cc).replace(/:/g, '-').replace(/\//g, '-');
                                        ...
                                        onMemberDecorator: function (decorator) {
                                            switch (decorator.decoratorType.name) {
                                                ...
                                                case 'mlAlert':
                                                    ...
                                                    var alertName = alertOptions.name || (s.classConstructorToString(cc).replace(/\//g, '-').replace(/:/g, '-') + '-' + member.name);
                                                ...
                                                case 'mlTask':
                                                    ...
                                                    var taskName = taskOptions.name || s.classConstructorToString(cc).replace(/\//g, '-').replace(/:/g, '-') + '-' + member.name;
