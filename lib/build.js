...
var Build = (function () {
    ...
    Build.prototype.runTasks = function (names) {
        var persistsModel = this.options.buildConfig.buildModelPersistance === MarkScript.BuildModelPersistance.NO_SOURCE || this.options.buildConfig.buildModelPersistance === MarkScript.BuildModelPersistance.ALL;
